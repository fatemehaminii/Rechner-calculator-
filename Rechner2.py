...
Eintrag_1 = Entry(Fenster, width=30, textvariable=derText_desEingangs)
...
def button(Text, Reihe, Pfeiler, Breite=10, height=3, rowspan=1, columnspan=1, command=None):
    Knopf = Button(master=Fenster, text=Text,
                   highlightbackground="gray", height=height, width=Breite, command=command)
